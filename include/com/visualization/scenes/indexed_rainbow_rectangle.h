#ifndef COM_VISUALIZATION_SCENES_INDEXED_RAINBOW_RECTANGLE_H_INCLUDED
#define COM_VISUALIZATION_SCENES_INDEXED_RAINBOW_RECTANGLE_H_INCLUDED
...
namespace com
{
  ...
  {
    class DLLSPEC_COM_VISUALIZATION indexed_rainbow_rectangle :
      public scene
    {
    public:
      indexed_rainbow_rectangle();
      virtual ~indexed_rainbow_rectangle();
