#ifndef COM_VISUALIZATION_SCENES_MULTI_TEXTURED_RECTANGLE_H_INCLUDED
#define COM_VISUALIZATION_SCENES_MULTI_TEXTURED_RECTANGLE_H_INCLUDED
...
namespace com
{
  ...
  {
    class DLLSPEC_COM_VISUALIZATION multi_textured_rectangle :
      public scene
    {
    public:
      multi_textured_rectangle();
      virtual ~multi_textured_rectangle();
